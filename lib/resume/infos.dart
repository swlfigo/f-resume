...
协同前端H5开发直播互动层。开发WebKit同层渲染互动层协议。接入PAG动效工作框架实现H5控制原生平台播放礼物动画。 
...
负责今日插件(Today Extentsion)开发 ; 在 弹幕评论组件 使用 异步绘制 与 缓存池 技术优化多评论弹出时性能问题。
负责竖屏短视频模块开发,为视频添加 边播缓存功能,做到节省流量与快速加载效果。
适配项目 OC , Swift 混编环境配置,使用 Socket.IO 与 SQLite 配合后端开发App内聊天IM模块。
